...
//    const posNotValidMarker = L.icon({
//        iconUrl: "./meshtasticVectors/marker-satKO-green.svg",
...
//                var positionIsValid = Feature.properties.positionIsValid;
//                if (positionIsValid == 1) {
//                    return { color: "green" };
//                }
//                else {
//                    return { color: "red" };
...
//            },
    ...
    var host="hub.iz1kga.it";//change this
    var port=9001;
